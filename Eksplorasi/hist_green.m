...
histogram_dir = 'C:\Users\Firda Sabrina\Documents\Kuli-Ah\TUGAS KULIAH\TUGAS SEM 6\Pengolahan Citra Biomedika\TUBES\MATLAB\training\green_histogram';
...
for k = 1:length(theFiles)
    ...
    figure;
    imhist(greenChannel);
    title('Histogram of Red Channel %s', baseFileName);
