...
histogram_dir = 'C:\Users\Firda Sabrina\Documents\Kuli-Ah\TUGAS KULIAH\TUGAS SEM 6\Pengolahan Citra Biomedika\TUBES\MATLAB\training\red channel image';
...
for k = 1:length(theFiles)
    ...
    %save the histogram
    saveas(gcf, fullfile(histogram_dir, [name, '_red.png']));
